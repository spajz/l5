...
@section('content')
    ...
    <ul class="nav nav-tabs tab-selector bottom10">
        <li class="{{ Session::get('settings.tab') == '#basic' ? 'active' : '' }}"><a href="{{ route("admin.{$moduleLower}.content") }}"><i class="fa fa-bars fa-fw"></i>Basic</a></li>
        <li class="{{ Session::get('settings.tab') == '#content' ? 'active' : '' }}"><a href="{{ route("admin.{$moduleLower}.content.page") }}"><i class="fa fa-folder-open-o fa-fw"></i> Content</a></li>
    </ul>
