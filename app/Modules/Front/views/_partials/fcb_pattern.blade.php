...
?>
<section class="fcb-pattern">
    @foreach($colors as $color)
        <div class="lsquare" style="@include('front::_partials.fcb_gradient', ['color' => $color])">&nbsp;</div>
    @endforeach
    <button type="button" class="btn btn-default btn-xs pattern-btn">Nemoj da klikneš ovde!</button>
</section>